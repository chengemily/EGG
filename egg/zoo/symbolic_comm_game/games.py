...
from egg.zoo.symbolic_comm_game.archs import Receiver, Sender
from egg.zoo.symbolic_comm_game.comm_game import Game
from egg.zoo.symbolic_comm_game.losses import get_loss
